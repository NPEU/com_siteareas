...
class SiteAreasModelSiteArea extends JModelAdmin
{
    ...
    public function save($data)
    {
        ...
        if ($data['params']['funder_module_id'] == 'autogenerate') {
            ...
            $module['access']     = $data['access'];
            $module['showtitle']  = 0;
            $module['params']     = json_decode('{"brand_id":"2","brand_url":"https:\/\/www.nihr.ac.uk\/funding-and-support\/funding-for-research-studies\/funding-programmes\/health-technology-assessment\/","statement":"<p class=\"u-text-size--small\">This study is funded by the National Institute for Health Research (NIHR) <a href=\"http:\/\/www.nihr.ac.uk\/funding-and-support\/funding-for-research-studies\/funding-programmes\/health-technology-assessment\/\" rel=\"external nofollow noreferrer\">Health Technology Assessment (HTA) Programme<\/a> (Reference Number [CHANGE ME]). The views expressed are those of the author(s) and not necessarily those of the NIHR or the Department of Health and Social Care.<\/p>\r\n","image":"assets\/images\/baby-asleep-198666544.jpg","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"Npeu6-magic","cta_text":"","cta_url":"","wrapper":"","theme":"","headline_image":""}', true);
