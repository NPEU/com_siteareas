...
namespace NPEU\Component\Siteareas\Administrator\Table;
...
/**
 * Sitearea Table class.
 *
 * @since  1.0
 */
#class SiteareaTable extends Nested implements VersionableTableInterface, TaggableTableInterface
class SiteareaTable extends Table
{
    ...
    public function __construct(DatabaseDriver $db) {
        $this->typeAlias = 'com_siteareas.sitearea';
    ...
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_siteareas.sitearea.'.(int) $this->$k;
    }
    /**
